#include "circuitdiagramwidget.h"
#include <QPainter>
#include <QPen>
#include <QBrush>
...
CircuitDiagramWidget::CircuitDiagramWidget(QWidget *parent)
    : QWidget(parent),
    m_powerLevel(0),
    m_warnLevel(20),
...
// Power Level
int CircuitDiagramWidget::powerLevel() const {
    return m_powerLevel;
}

void CircuitDiagramWidget::setPowerLevel(int level) {
...
// Warn Level
int CircuitDiagramWidget::warnLevel() const {
    return m_warnLevel;
}

void CircuitDiagramWidget::setWarnLevel(int level) {
...
bool CircuitDiagramWidget::mainContactorClosed() const {
    return m_mainContactorClosed;
}

void CircuitDiagramWidget::setMainContactorClosed(bool closed) {
...
bool CircuitDiagramWidget::heaterErrorContactorClosed() const {
    return m_heaterErrorContactorClosed;
}

void CircuitDiagramWidget::setHeaterErrorContactorClosed(bool closed) {
...
// Is Heating
bool CircuitDiagramWidget::isHeating() const {
    return m_isHeating;
}

void CircuitDiagramWidget::setIsHeating(bool heating) {
...
bool CircuitDiagramWidget::dischargeContactorClosed() const {
    return m_dischargeContactorClosed;
}

void CircuitDiagramWidget::setDischargeContactorClosed(bool closed) {
...
bool CircuitDiagramWidget::chargeContactorClosed() const {
    return m_chargeContactorClosed;
}

void CircuitDiagramWidget::setChargeContactorClosed(bool closed) {
...
bool CircuitDiagramWidget::limitedContactorClosed() const {
    return m_limitedContactorClosed;
}

void CircuitDiagramWidget::setLimitedContactorClosed(bool closed) {
...
bool CircuitDiagramWidget::heaterContactorClosed() const {
    return m_heaterContactorClosed;
}

void CircuitDiagramWidget::setHeaterContactorClosed(bool closed) {
...
void CircuitDiagramWidget::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event);
...
void CircuitDiagramWidget::drawBattery(QPainter &painter, int x, int y, int width, int height)
{
    // 设置视口和窗口
...
void CircuitDiagramWidget::drawWireToMainContactor(QPainter &painter, int batteryX, int batteryY, int batteryWidth, int batteryHeight)
{
    // 还原视口和窗口设置，以绘制其他部分
...
void CircuitDiagramWidget::drawMainContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
...
void CircuitDiagramWidget::drawWireToHeaterErrorContactor(QPainter &painter, int startX, int startY, int batteryWidth)
{
    // 垂直线长度为电池宽度的1/6
...
void CircuitDiagramWidget::drawHeaterErrorContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
    int centerDistance = batteryWidth / 3; // 调整为电池宽度的1/3
...
void CircuitDiagramWidget::drawHeater(QPainter &painter, int x, int y, int side)
{
    // 设置正方形边框画笔颜色和宽度
...
void CircuitDiagramWidget::drawWireToDischargeContactor(QPainter &painter, int batteryX, int batteryY, int batteryWidth, int batteryHeight)
{
    // 设置画笔颜色
...
void CircuitDiagramWidget::drawDischargeContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
    int centerDistance = batteryWidth / 3; // 调整为电池宽度的1/3
...
void CircuitDiagramWidget::drawWireToChargeContactor(QPainter &painter, int dischargeContactorX, int dischargeContactorY, int batteryWidth)
{
    // 设置画笔颜色
    QPen pen(Qt::black);
    pen.setWidth(2);
...
void CircuitDiagramWidget::drawChargeContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
...
void CircuitDiagramWidget::drawWireToBusMinus(QPainter &painter, int startX, int startY, int batteryWidth)
{
    // 设置画笔颜色
    QPen pen(Qt::black); // 导线颜色
    pen.setWidth(2);
...
void CircuitDiagramWidget::drawWireToLimitedContactor(QPainter &painter, int midX, int midY, int batteryWidth)
{
    // 垂直线的长度
...
void CircuitDiagramWidget::drawLimitedContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
    int centerDistance = batteryWidth / 3;
...
void CircuitDiagramWidget::drawWireToHeaterContactor(QPainter &painter, int heaterX, int heaterY, int heaterSize, int batteryWidth, int batteryY, int batteryHeight)
{
    // 垂直线的长度
...
void CircuitDiagramWidget::drawHeaterContactor(QPainter &painter, int x, int y, int batteryWidth, int batteryY, int batteryHeight)
{
    int radius = 4;
    int centerDistance = batteryWidth / 3;
