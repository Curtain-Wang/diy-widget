...
void MyWidget::paintEvent(QPaintEvent *event)
{
    ...
    // 使用新方法绘制带有动态填充效果的水平向左的折线
    drawHorLeftZigzagLine(painter, 200, 200, 10, 200, Qt::red, Qt::green);

    // 使用新方法绘制带有动态填充效果的垂直向上的折线
    drawVerUpZigzagLine(painter, 10, 200, 10, 10, Qt::red, Qt::green);
}
...
void MyWidget::drawHorLeftZigzagLine(QPainter &painter, int startX, int startY, int endX, int endY, const QColor &lineColor, const QColor &fillColor)
{
    // 设置线条颜色
    QPen pen(lineColor);
    pen.setWidth(5);
...
void MyWidget::drawVerUpZigzagLine(QPainter &painter, int startX, int startY, int endX, int endY, const QColor &lineColor, const QColor &fillColor)
{
    // 设置线条颜色
    QPen pen(lineColor);
    pen.setWidth(5);
