#ifndef CircuitDiagramWidget1109_H
#define CircuitDiagramWidget1109_H

#include <QWidget>
class QTimer;
class QRect;
class CircuitDiagramWidget1109 : public QWidget
{
    Q_OBJECT
...
public:
    explicit CircuitDiagramWidget1109(QWidget *parent = nullptr);
    ~CircuitDiagramWidget1109();
...
#endif // CircuitDiagramWidget1109_H
