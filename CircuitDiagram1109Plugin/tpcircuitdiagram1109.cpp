...
#include <QTimer>
TPCircuitDiagram1109::TPCircuitDiagram1109(QWidget *parent)
    : QWidget(parent)
{
    init();
}

double TPCircuitDiagram1109::current1() const
{
    return m_current1;
}

void TPCircuitDiagram1109::setCurrent1(double value)
{
...
double TPCircuitDiagram1109::current2() const
{
    return m_current2;
}
void TPCircuitDiagram1109::setCurrent2(double value)
{
...
int TPCircuitDiagram1109::chargeLevel1() const
{
    return m_chargeLevel1;
}
void TPCircuitDiagram1109::setChargeLevel1(int value)
{
...
int TPCircuitDiagram1109::chargeLevel2() const
{
    return m_chargeLevel2;
}
void TPCircuitDiagram1109::setChargeLevel2(int value)
{
...
bool TPCircuitDiagram1109::dischargeContactorClosed1() const
{
    return m_dischargeContactorClosed1;
}
void TPCircuitDiagram1109::setDischargeContactorClosed1(bool value)
{
...
bool TPCircuitDiagram1109::dischargeContactorClosed2() const { return m_dischargeContactorClosed2; }

void TPCircuitDiagram1109::setDischargeContactorClosed2(bool value)
{
...
bool TPCircuitDiagram1109::chargeContactorClosed1() const { return m_chargeContactorClosed1; }

void TPCircuitDiagram1109::setChargeContactorClosed1(bool value)
{
...
bool TPCircuitDiagram1109::chargeContactorClosed2() const { return m_chargeContactorClosed2; }

void TPCircuitDiagram1109::setChargeContactorClosed2(bool value)
{
...
bool TPCircuitDiagram1109::limitedContactorClosed1() const { return m_limitedContactorClosed1; }

void TPCircuitDiagram1109::setLimitedContactorClosed1(bool value)
{
...
bool TPCircuitDiagram1109::limitedContactorClosed2() const { return m_limitedContactorClosed2; }

void TPCircuitDiagram1109::setLimitedContactorClosed2(bool value)
{
...
int TPCircuitDiagram1109::warningLevel() const { return m_warningLevel; }

void TPCircuitDiagram1109::setWarningLevel(int value)
{
...
double TPCircuitDiagram1109::systemVoltage() const { return m_systemVoltage; }

void TPCircuitDiagram1109::setSystemVoltage(double value)
{
...
bool TPCircuitDiagram1109::mainContactorClosed() const { return m_mainContactorClosed; }

void TPCircuitDiagram1109::setMainContactorClosed(bool value)
{
...
bool TPCircuitDiagram1109::heaterFaultContactorClosed() const { return m_heaterFaultContactorClosed; }

void TPCircuitDiagram1109::setHeaterFaultContactorClosed(bool value)
{
...
bool TPCircuitDiagram1109::isHeating() const { return m_isHeating; }

void TPCircuitDiagram1109::setIsHeating(bool value)
{
...
bool TPCircuitDiagram1109::heaterContactorClosed() const { return m_heaterContactorClosed; }

void TPCircuitDiagram1109::setHeaterContactorClosed(bool value)
{
...
QList<QColor> TPCircuitDiagram1109::packColors1() const { return m_packColors1; }

void TPCircuitDiagram1109::setPackColors1(const QList<QColor> &value) { m_packColors1 = value; update();}

QList<QColor> TPCircuitDiagram1109::packColors2() const { return m_packColors2; }

void TPCircuitDiagram1109::setPackColors2(const QList<QColor> &value) { m_packColors2 = value; update();}

int TPCircuitDiagram1109::language() const { return m_language; }

void TPCircuitDiagram1109::setLanguage(int value)
{
    if(m_language != value)
    {
        m_language = value;
...
int TPCircuitDiagram1109::componentState() const { return m_componentState; }

void TPCircuitDiagram1109::setComponentState(int value)
{
...
void TPCircuitDiagram1109::drawBatteryBody(QPainter &painter, const QRect &batteryRect, const QRect &blueRect) {
...
void TPCircuitDiagram1109::drawElectrodes(QPainter &painter, const QRect &batteryRect) {
...
void TPCircuitDiagram1109::drawTrapezoid(QPainter &painter, const QRect &blueRect, int borderSize, int trapezoidHeight) {
...
void TPCircuitDiagram1109::drawBase(QPainter &painter, const QRect &blueRect, int borderSize, int trapezoidHeight) {
...
void TPCircuitDiagram1109::drawChargeLevel(QPainter &painter, const QRect &batteryRect) {
 ...
 * @brief TPCircuitDiagram1109::drawWireToMainContactor
 * @param painter
 * @param batteryX
 * @param batteryY
 * @param batteryWidth
 * @param batteryHeight
 */
void TPCircuitDiagram1109::drawWireToMainContactor(QPainter &painter, int batteryX, int batteryY, int batteryWidth, int batteryHeight)
{
    // 还原视口和窗口设置，以绘制其他部分
...
void TPCircuitDiagram1109::on_timer_timeout()
{
...
void TPCircuitDiagram1109::drawMainContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
 ...
 * 长度747 * 3 / 10
 * @brief TPCircuitDiagram1109::drawWireToSystemVoltage
 * @param painter
 * @param mainContactorX
 * @param mainContactorY
 * @param batteryWidth
 */
void TPCircuitDiagram1109::drawWireToSystemVoltage(QPainter &painter, int mainContactorX, int mainContactorY, int batteryWidth)
{
 ...
 * 长度305 / 12
 * 充电起点747 * 11 / 120
 * @brief TPCircuitDiagram1109::drawWireToHeaterFaultContactor
 * @param painter
 * @param mainContactorX
 * @param mainContactorY
 * @param batteryWidth
 */
void TPCircuitDiagram1109::drawWireToHeaterFaultContactor(QPainter &painter, int mainContactorX, int mainContactorY, int batteryWidth)
{
...
void TPCircuitDiagram1109::drawHeaterFaultContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
    int centerDistance = batteryWidth / 4; // 调整为电池宽度的1/4
 ...
 * @brief TPCircuitDiagram1109::drawWireToHeater
 * @param painter
 * @param heaterFaultContactorX
 * @param heaterFaultContactorY
 * @param batteryWidth
 */
void TPCircuitDiagram1109::drawWireToHeater(QPainter &painter, int heaterFaultContactorX, int heaterFaultContactorY, int batteryWidth)
{
...
void TPCircuitDiagram1109::drawHeater(QPainter &painter, int x, int y, int side)
{
    // 设置正方形边框画笔颜色和宽度
 ...
 * @brief TPCircuitDiagram1109::drawWireToHeaterContactor
 * @param painter
 * @param heaterX
 * @param heaterY
 * @param heaterWidth
 */
void TPCircuitDiagram1109::drawWireToHeaterContactor(QPainter &painter, int heaterX, int heaterY, int heaterWidth)
{
 ...
 * @brief TPCircuitDiagram1109::drawHeaterContactor
 * @param painter
 * @param x
 * @param y
 */
void TPCircuitDiagram1109::drawHeaterContactor(QPainter &painter, int x, int y)
{
    int radius = 4;
...
void TPCircuitDiagram1109::drawSystemVoltage(QPainter &painter, int startX, int startY)
{
    // 还原视口和窗口设置，以绘制其他部分
    painter.setViewport(0, 0,747,305);
    painter.setWindow(0, 0,747,305);
 ...
 * @brief TPCircuitDiagram1109::drawWireToDischargeContactor
 * @param painter
 * @param startX
 * @param startY
 */
void TPCircuitDiagram1109::drawWireToDischargeContactor(QPainter &painter, int startX, int startY)
{
    // 设置画笔颜色
    QPen pen(Qt::black);
    // 绘制水平向右的线
...
void TPCircuitDiagram1109::drawBottomWire(QPainter &painter, int startX, int startY)
{
    // 设置画笔颜色
    QPen pen(Qt::black);
    pen.setWidth(2);
...
void TPCircuitDiagram1109::drawDischargeContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
 ...
 * 长度：width() / 6 +305 / 6
 * @brief TPCircuitDiagram1109::drawWireToLimitedContactor
 * @param painter
 * @param dischargeContactorX
 * @param dischargeContactorY
 * @param chargeContactorX
 */
void TPCircuitDiagram1109::drawWireToLimitedContactor(QPainter &painter, int dischargeContactorX, int dischargeContactorY, int chargeContactorX)
{
    // 还原视口和窗口设置，以绘制其他部分
    painter.setViewport(0, 0,747,305);
    painter.setWindow(0, 0,747,305);
 ...
 * 长度：width() / 6 +305 / 6
 * @brief TPCircuitDiagram1109::drawLimitedContactor
 * @param painter
 * @param x
 * @param y
 */
void TPCircuitDiagram1109::drawLimitedContactor(QPainter &painter, int x, int y)
{
    int radius = 4;
    int centerDistance =747 / 20; // 调整为电池宽度的1/4
...
void TPCircuitDiagram1109::drawGradientLineSegment(int x1, int y1, int x2, int y2, Qt::GlobalColor edgeColor, QPainter &painter, double color2At)
{
    //绘制能量块覆盖的部分
...
void TPCircuitDiagram1109::drawGradientPolylineSegment(int x1, int y1, int x2, int y2, int x3, int y3, Qt::GlobalColor edgeColor, QPainter &painter)
{
    // 计算渐变起点和终点，跨越垂直和水平部分
...
void TPCircuitDiagram1109::buildEnergyPositionListWithLimit()
{
...
void TPCircuitDiagram1109::buildChargeHeatEnergyPositionList()
{
...
void TPCircuitDiagram1109::buildEnergyPositionListWithCharge()
{
    energyPositionList.clear();
    energyPositionList = {
...
void TPCircuitDiagram1109::drawSeriesVoltage(QPainter &painter, int n)
{
    //绘制右侧的“串电压”和方框
    painter.setPen(Qt::black);
 ...
 * 长度：width() / 8 +747 / 24
 * @brief TPCircuitDiagram1109::drawWireToChargeContactor
 * @param painter
 * @param startX
 * @param startY
 * @param batteryWidth
 */
void TPCircuitDiagram1109::drawWireToChargeContactor(QPainter &painter, int startX, int startY, int batteryWidth)
{
    // 设置画笔颜色
    QPen pen(Qt::black); // 导线颜色
    pen.setWidth(5);
...
void TPCircuitDiagram1109::drawChargeContactor(QPainter &painter, int x, int y, int batteryWidth)
{
    int radius = 4;
    int centerDistance = batteryWidth / 4; // 调整为电池宽度的1/4
 ...
 * @brief TPCircuitDiagram1109::drawWireFromNegativeElectrode
 * @param painter
 * @param batteryX
 * @param batteryY
 * @param batteryWidth
 * @param batteryHeight
 */
void TPCircuitDiagram1109::drawWireFromNegativeElectrode(QPainter &painter, int batteryX, int batteryY, int batteryWidth, int batteryHeight)
{
    // 还原视口和窗口设置，以绘制其他部分
    painter.setViewport(0, 0,747,305);
    painter.setWindow(0, 0,747,305);
...
void TPCircuitDiagram1109::paintEvent(QPaintEvent *event) {
    Q_UNUSED(event);
...
void TPCircuitDiagram1109::init()
{
    m_chargeLevel1 = 100;
    m_chargeLevel2 = 100;
    m_warningLevel = 20;
    ...
    connect(timer, &QTimer::timeout, this, &TPCircuitDiagram1109::on_timer_timeout);
}
