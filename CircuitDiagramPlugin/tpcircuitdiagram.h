#ifndef TPCIRCUITDIAGRAM_H
#define TPCIRCUITDIAGRAM_H

#include <QWidget>
#include <QtUiPlugin/QDesignerExportWidget>
class QDESIGNER_WIDGET_EXPORT TPCircuitDiagram : public QWidget
{
    Q_OBJECT
...
public:
    explicit TPCircuitDiagram(QWidget *parent = nullptr);
